...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($data->user_id, $data->room_id, $data->checkin_date, $data->checkout_date, $data->room_amount, $data->total_price, $data->payment_id)) {
        ...
        $payment_id = $data->payment_id; // Retrieve payment_id from POST data
        ...
        $stmt->bind_param("iisssii", $user_id, $room_id, $checkin_date, $checkout_date, $room_amount, $total_price, $payment_id);
